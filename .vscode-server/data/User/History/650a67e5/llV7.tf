...
resource "aws_route53_record" "writer" {
  zone_id = "Z06059502PUTTMM9EB3FU"          # Put your Host zone id
  name    = "writer.altyok.com"   # Put your domain name; wordpress.yourdomain.com
  type    = "CNAME"
  ttl     = "30"
  records = [writer.cxeepamrgxao.us-east-1.rds.amazonaws.com]

}

resource "aws_route53_record" "reader1" {
  zone_id = "Z06059502PUTTMM9EB3FU"          # Put your Host zone id
  name    = "reader1.altyok.com"   # Put your domain name; wordpress.yourdomain.com
  type    = "CNAME"
  ttl     = "30"
  records = [reader1.cxeepamrgxao.us-east-1.rds.amazonaws.com]

}

resource "aws_route53_record" "reader2" {
  zone_id = "Z06059502PUTTMM9EB3FU"          # Put your Host zone id
  name    = "reader2.altyok.com"   # Put your domain name; wordpress.yourdomain.com
  type    = "CNAME"
  ttl     = "30"
  records = [reader2.cxeepamrgxao.us-east-1.rds.amazonaws.com]

}

resource "aws_route53_record" "reader3" {
  zone_id = "Z06059502PUTTMM9EB3FU"          # Put your Host zone id
  name    = "reader3.altyok.com"   # Put your domain name; wordpress.yourdomain.com
  type    = "CNAME"
  ttl     = "30"
  records = [reader3.cxeepamrgxao.us-east-1.rds.amazonaws.com]
